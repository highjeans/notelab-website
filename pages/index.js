...
export default function App() {
    return (
        <>
            ...
            <Card css={{"border-radius": 0, background: "black", "text-align": "center", height: "100px"}}>
                <Text color="white" css={{margin: "42px"}}>
                    Copyright © 2022 NoteLab. Created by Tanvi Waghela and Vivan Waghela
                </Text>
            </Card>
        </>
    );
